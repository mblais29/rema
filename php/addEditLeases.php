    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		case 'one':
			try {
				...
				$sql="INSERT INTO $schema_name.property_lease(tenant_id, lease_start_date, lease_end_date, lease_amount, lease_freq, property_id, lease_deposit)
	    		VALUES ('$_POST[tenant]', '$_POST[leaseStart]', '$_POST[leaseEnd]', '$_POST[leaseAmount]', '$_POST[freq]', '$_POST[property]', '$_POST[deposit]')";

		      	//Executes the Postgresql Query
		      	pg_query($dbconn, $sql);
				//echo $_POST['userName'];
				echo "Created the Lease Successfully!";
			}catch (Exception $e) {
